...
import { setRoot, getRoot } from './root.ts';
...
function showSettings() {
    ...
    const panel = createModal(root, 'hermes-settings-panel', 'Hermes Settings', content, '600px', '<button id="hermes-save-settings">Save</button>');
...
export async function initUI() {
    ...
    container.style.cssText = 'position:fixed;top:10px;right:10px;background:var(--hermes-bg);color:var(--hermes-text);padding:5px;border:1px solid #999';
